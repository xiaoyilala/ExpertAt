...
import com.ice.expertat.internal.StringUtils;
...
public class TrackingAspectJ {
    ...
    private static final String POINTCUT_METHOD = "execution(@com.ice.expertat.Tracking * *(..))";
    ...
    public Object traceMethod(final ProceedingJoinPoint joinPoint, Tracking tracking) throws Throwable {
        ...
        if (tracking == null || ! ExpertAt.isDebug()) {
